...
from oauth.google import GoogleOAuth2Handler, GoogleSignoutHandler, GoogleDriveProvidersHandler
...
def main():
    ...
    application = tornado.web.Application([
        ...
        (r"/auth/providers/google/drive/(.*)", GoogleDriveProvidersHandler),
